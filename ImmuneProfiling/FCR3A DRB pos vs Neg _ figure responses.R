...
variables <- c("FcγRIIIa_EBNA1_421_476_B958", "FcγRIIIa_EBNA1_589_641_B958", "FcγRIIIa_EBNA1_589_641_AG876", 
...
ggsave(paste0(save_path, "FcγRIIIa_DRB_Ebna1_with_FDR.tiff"), 
       plot = combined_plot, 
       device = "tiff", 
       dpi = 450, 
       width = 8, 
