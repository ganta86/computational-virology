...
create_heatmap(Data_mean_global_zscore, 1:11, "FCR3a")

# Generate the heatmap as a ggplot object
heatmap_plot <- create_heatmap(Data_mean_global_zscore, 1:11, "FCR3a")
...
ggsave(filename = paste0(save_path, "heatmap_FCR3a.pdf"), 
       plot = heatmap_plot, 
       device = "pdf", 
