...
create_heatmap(Data_mean_global_zscore, 1:11, "IgG3")

# Generate the heatmap as a ggplot object
heatmap_plot <- create_heatmap(Data_mean_global_zscore, 1:11, "IgG3")
...
ggsave(filename = paste0(save_path, "heatmap_EBNA_IgG3.pdf"), 
       plot = heatmap_plot, 
       device = "pdf", 
