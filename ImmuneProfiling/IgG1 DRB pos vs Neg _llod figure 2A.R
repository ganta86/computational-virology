...
# Function to apply LLOD threshold to all relevant samples
apply_llod_to_data <- function(data, variables, LLOD_values) {
...
# Apply LLOD adjustment to your data
COMPILED_DATA_EBNA1b <- apply_llod_to_data(COMPILED_DATA_EBNA1b, variables, LLOD_values)
