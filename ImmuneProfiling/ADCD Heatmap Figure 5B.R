...
create_heatmap(Data_mean_global_zscore, 1:11, "ADCD")

# Generate the heatmap as a ggplot object
heatmap_plot <- create_heatmap(Data_mean_global_zscore, 1:11, "ADCD")
heatmap_plot
...
ggsave(filename = paste0(save_path, "heatmap_EBNA_ADCD.pdf"), 
       plot = heatmap_plot, 
       device = "pdf", 
