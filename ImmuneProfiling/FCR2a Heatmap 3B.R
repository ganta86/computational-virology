...
create_heatmap(Data_mean_global_zscore, 1:11, "FCR2a")

# Generate the heatmap as a ggplot object
heatmap_plot <- create_heatmap(Data_mean_global_zscore, 1:11, "FCR2a - Global Z-Score Normalization")
...
ggsave(filename = paste0(save_path, "heatmap_FCR2A11.pdf"), 
       plot = heatmap_plot, 
       device = "pdf", 
